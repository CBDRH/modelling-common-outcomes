...
_To test your understanding of the concepts in the previous section, try answering the following questions on odds and risk ratios. You can use R programmi.g code within the interactive coding blocks to perform any calculations. Click the hint button if you need help getting started._
